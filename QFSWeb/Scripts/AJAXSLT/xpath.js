...
// BUGBUG: Parser is matching ncname as qname
// BUGBUG: namespace-uri is being parsed as AXISNAME - uri
...
var TOK_AXIS =   { label: "::",  prec:   40, re: new RegExp("^::")  };
...
var xpathTokenRules = [
    ...
    TOK_AXIS,  
    TOK_COLON,
//TOK_AXISNAME, // [Jimmy] Removing the AXISNAME token for now as it is ambiguous with QNAME
    TOK_NODEO,
    TOK_PARENO,
    TOK_PARENC,
    TOK_BRACKO,
...
var xpathGrammarRules =
  [
   ...
   [ XPathStep, [ TOK_DDOT ], 33,
     makeStepExpr2 ],
   [ XPathStep,
     [ TOK_QNAME, TOK_AXIS, XPathNodeTest ], 33,
     makeStepExpr3 ],
